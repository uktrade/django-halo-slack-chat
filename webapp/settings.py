...
# A list of bots that are allowed to create Halo tickets.
ALLOWED_BOT_IDS = [
    allowed_bot_id
...
HALO_CLIENT_IDENTIFIER = os.environ.get(
    'HALODESK_CLIENT_IDENTIFIER', 'YOUR HALO CLIENT UNIQUE IDENTIFIER'
)
HALO_CLIENT_SECRET = os.environ.get(
    'HALO_CLIENT_SECRET', 'YOUR HALO CLIENT SECRET'
)
HALO_SUBDOMAIN = os.environ.get(
    'HALO_SUBDOMAIN', 'YOUR HALO SUBDOMAIN'
)
HALO_REDIRECT_URI = os.environ.get(
    'HALO_REDIRECT_URI', 'YOUR URI FOR http(s)://<our host>/halo/oauth'
)
HALO_TICKET_URI = os.environ.get(
    'HALO_TICKET_URI', 'https://<YOUR SUBDOMAIN>.halo.com/agent/tickets'
)
HALO_USER_ID = os.environ.get(
    'HALO_USER_ID', '<The user id to assign new halo tickets to>'
)
HALO_GROUP_ID = os.environ.get(
    'HALO_GROUP_ID', '<The group id new halo tickets belong to>'
)
HALO_WEBHOOK_USER = os.environ.get(
    'HALO_WEBHOOK_USER', '<some random username>'
)
HALO_WEBHOOK_TOKEN = os.environ.get(
    'HALO_WEBHOOK_TOKEN', '<shared secret random string>'
)
HALO_AGENT_EMAIL = os.environ.get(
    'HALO_AGENT_EMAIL', '<email of haloslackchat agent>'
)
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'haloslackchat.apps.HaloSlackChatConfig',
    'authbroker_client',
]
