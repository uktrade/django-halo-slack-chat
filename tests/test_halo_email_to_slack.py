...
from haloslackchat.message import message_who_is_on_call
...
@patch('haloslackchat.halo_email_to_slack.get_ticket')
@patch('haloslackchat.halo_email_to_slack.add_comment')
@patch('haloslackchat.halo_email_to_slack.message_issue_halo_url')
@patch('haloslackchat.halo_email_to_slack.message_who_is_on_call')
@patch('haloslackchat.halo_email_to_slack.SlackApp')
@patch('haloslackchat.halo_email_to_slack.HaloApp')
def test_email_from_halo_is_added_for_tracking(
    HaloApp, SlackApp, message_who_is_on_call, message_issue_halo_url, 
    ...
    settings = dict(
        ...
        HALO_USER_ID='1234',
        HALO_GROUP_ID='7890',
        HALO_TICKET_URI='https://z.e.n.d.e.s.k',
    ...
    issue = HaloSlackChat.get('C024JUTACTS', '1597940362.013100')
    ...
    # Halo issue will be updated with link to slack issue SRE team looks at
